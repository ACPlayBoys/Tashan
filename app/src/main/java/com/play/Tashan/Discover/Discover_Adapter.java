...
public class Discover_Adapter extends RecyclerView.Adapter<Discover_Adapter.CustomViewHolder > implements Filterable {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Discover_Get_Set row : datalist) {
                        ...
                        String description=getDescription(row.arrayList.get(0)).toLowerCase();
                        if (description.contains(charString.toLowerCase())) {
    ...
    private String getDescription(Home_Get_Set row) {
        return row.video_description+" "+row.last_name+" "+row.first_name+" "+row.created_date;
    }
