...
public class Profile_Tab_F extends RootFragment implements View.OnClickListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context=getContext();
        sharedPreferences=getContext().getSharedPreferences(Variables.pref_name,MODE_PRIVATE);
    ...
    private void Call_Api_For_get_Allvideos() {
        ...
        */
        DatabaseReference reference=FirebaseDatabase.getInstance().getReference("users").child(Variables.sharedPreferences.getString(Variables.u_id,""));
