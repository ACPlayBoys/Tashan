...
import com.play.Tashan.Following.Following_F;
import com.play.Tashan.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.play.Tashan.Profile.Liked_Videos.Liked_Video_F;
import com.play.Tashan.Profile.UserVideos.UserVideo_F;
import com.play.Tashan.R;
import com.play.Tashan.See_Full_Image_F;
   ...
   public  TextView follow_count_txt,fans_count_txt,heart_count_txt;
    ...
    public void Parse_data(DataSnapshot snapshot){
        ...
        try {/*
            ...
            username.setText(snapshot.child("first_name").getValue().toString()+" "+snapshot.child("last_name").getValue().toString());

            Profile_F.pic_url=snapshot.child("profile_pic").getValue().toString();
            Picasso.with(context)
                    .load(Profile_F.pic_url)
                    .placeholder(context.getResources().getDrawable(R.drawable.profile_image_placeholder))
                    .resize(200,200).centerCrop().into(imageView);

            follow_count_txt.setText("0");
            if(snapshot.hasChild("following"))
                follow_count_txt.setText(String.valueOf(snapshot.child("following").getChildrenCount()));

            fans_count_txt.setText("0");
            if(snapshot.hasChild("followers"))
                fans_count_txt.setText(String.valueOf(snapshot.child("followers").getChildrenCount()));
            if(snapshot.hasChild("total_heart"))
                heart_count_txt.setText(snapshot.child("total_heart").getValue().toString());
            if(!snapshot.child("id").getValue().toString().
                ...
                Log.e("anikete",Variables.sharedPreferences.getString(Variables.u_id,""));
                if(snapshot.child("followers").hasChild(Variables.sharedPreferences.getString(Variables.u_id,""))) {
                    Log.e("anikete", "following");
                    follow_unfollow_btn.setBackgroundColor(getResources().getColor(R.color.gray));
                    follow_unfollow_btn.setText("Following");
                    follow_status = "1";
                }
                else {

                    follow_unfollow_btn.setBackgroundColor(getResources().getColor(R.color.redcolor));
            ...
            long count=snapshot.child("uploads").getChildrenCount();
            String user_videos=String .valueOf(count);

            video_count_txt.setText(user_videos+" Videos");
