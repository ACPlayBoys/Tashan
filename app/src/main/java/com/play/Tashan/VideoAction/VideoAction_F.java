package com.play.Tashan.VideoAction;
...
public class VideoAction_F extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void Open_App(ResolveInfo resolveInfo) {
        try {
            ...
            intent.setType("text/plain");
            intent.putExtra(Intent.EXTRA_TEXT, "www.weplayers.com/tashan/id="+video_id);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.copy_layout:
                ...
                ClipData clip = ClipData.newPlainText("Copied Text", "www.weplayers.com/tashan/id="+video_id);
