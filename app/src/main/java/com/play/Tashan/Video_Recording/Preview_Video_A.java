...
import com.play.Tashan.Filter.FilterType;
import com.play.Tashan.Filter.Filter_Adapter;
...
public class Preview_Video_A extends AppCompatActivity  implements Player.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.next_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Save_Video(Variables.outputfile2,Variables.output_filter_filee);
            }
        });
    ...
    public void Merge_withAudio(){
        ...
        String video = Variables.output_filter_filee;
        String finaloutput = Variables.output_filter_file;

        Merge_Video_Audio merge_video_audio=new Merge_Video_Audio(this);
        merge_video_audio.doInBackground(audio_file,video,finaloutput,"1");
