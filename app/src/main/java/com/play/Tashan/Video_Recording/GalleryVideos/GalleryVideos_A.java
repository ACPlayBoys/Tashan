package com.play.Tashan.Video_Recording.GalleryVideos;
...
import com.play.Tashan.Video_Recording.GallerySelectedVideo.GallerySelectedVideo_A;
...
public class GalleryVideos_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       recyclerView=findViewById(R.id.recylerview);
        ...
        adapter=new GalleryVideos_Adapter(this, data_list, new GalleryVideos_Adapter.OnItemClickListener() {
            ...
            public void onItemClick(int postion, GalleryVideo_Get_Set item, View view) {
                ...
                if(item.video_duration_ms<Variables.max_recording_duration){
                    ...
                    try {
                        startTrim(new File(item.video_path), new File(Variables.gallery_trimed_video), 1000, Variables.max_recording_duration);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
        ...
        @Override
            public void run() {
            GalleryVideos_A.this.runOnUiThread(new Runnable() {
        ...
        if (cursor != null) {
             while (cursor.moveToNext()) {
                ...
                item.video_path=cursor.getString(0);
                 ...
                 if(item.video_duration_ms>5000&&item.video_duration_ms<600000){
