package com.play.Tashan.Video_Recording.GallerySelectedVideo;
...
import com.play.Tashan.SoundLists.SoundList_Main_A;
import com.play.Tashan.Video_Recording.Merge_Video_Audio;
import com.play.Tashan.Video_Recording.Preview_Video_A;
...
import static com.play.Tashan.Video_Recording.Video_Recoder_A.Sounds_list_Request_code;
...
public class GallerySelectedVideo_A extends AppCompatActivity implements View.OnClickListener,Player.EventListener{
    ...
    public void Merge_withAudio(){
        ...
        String root = Variables.app_folder;
        String audio_file;
        ...
        merge_video_audio.doInBackground(audio_file,video,finaloutput,"0");
