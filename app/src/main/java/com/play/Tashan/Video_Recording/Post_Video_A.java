...
import com.play.Tashan.Services.ServiceCallback;
import com.play.Tashan.Services.Upload_Service;
...
public class Post_Video_A extends AppCompatActivity implements ServiceCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, Variables.f_name, Toast.LENGTH_SHORT).show();

        video_path = Variables.output_filter_filee;
...
// this will start the service for uploading the video into database
    public void Start_Service(){
        ...
        Upload_Service mService = new Upload_Service(serviceCallback,this.getApplicationContext());
