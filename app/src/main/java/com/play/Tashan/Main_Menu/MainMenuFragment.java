package com.play.Tashan.Main_Menu;
...
import com.play.Tashan.Accounts.Login_A;
import com.play.Tashan.Discover.Discover_F;
import com.play.Tashan.Home.Home_F;
import com.play.Tashan.Inbox.Inbox_F;
import com.play.Tashan.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
import com.play.Tashan.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.play.Tashan.Notifications.Notification_F;
import com.play.Tashan.Profile.Profile_Tab_F;
import com.play.Tashan.R;
import com.play.Tashan.SimpleClasses.Variables;
import com.play.Tashan.Video_Recording.Video_Recoder_A;
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener(){
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    ...
                    case 3:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_inbox));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.app_color));
                        break;
                    case 4:
